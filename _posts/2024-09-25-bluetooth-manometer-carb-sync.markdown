...
| ![Assembled Device](/assets/bluetooth_manometer/DeviceInternals.jpg) |
| :--: |
| The device with the top of the case removed |
| :--: |
| ![Top View](/assets/bluetooth_manometer/DeviceTop.jpg) |
| :--: |
| Top down view of the device |
| :--: |
| ![Underside View](/assets/bluetooth_manometer/DeviceUnderside.jpg) |
| :--: |
| Underside view of the device |
